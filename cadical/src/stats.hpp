...
struct Stats {
  ...
  int64_t total_propagations() const {
    return propagations.cover + propagations.instantiate + propagations.probe +
           propagations.search + propagations.transred + propagations.vivify +
           propagations.walk;
  }
